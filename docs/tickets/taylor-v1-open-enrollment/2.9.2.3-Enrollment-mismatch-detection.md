# 2.9.2.3 - Enrollment mismatch detection

## Traceability
- **Asana task ID:** `1213863006807842`
- **Section:** Backlog
...
- The implemented behavior satisfies: Enrollment mismatch detection.
...
- [ ] The outcome for “Enrollment mismatch detection” is demonstrable in a non-production or staging environment.
