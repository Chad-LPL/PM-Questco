...
Deliver the capability described in the ticket title: Server-side validation of submitted workbook data. This is part of Taylor V1 open enrollment orchestration. Data ingestion, validation, and normalization ahead of workbook and document generation.

## Product requirements (verifiable)

- The implemented behavior satisfies: Server-side validation of submitted workbook data.
